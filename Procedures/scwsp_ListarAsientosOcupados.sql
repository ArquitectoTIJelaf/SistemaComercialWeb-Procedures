...
as
	...
	Else
		Begin
			...
			--Tabla Venta
			Select top 10 v.NUME_ASIENTO,v.TIPO_DOC Tipo_Documento,v.DNI Numero_Documento,v.NIT_CLIENTE Ruc_Contacto,
			vd.Fecha_Viaje,v.FECH_VENTA Fecha_Venta,vd.Nacionalidad,v.PREC_VENTA Precio_Venta,v.RECO_VENTA Recoge_En,
			cd.Color, FLAG_VENTA,pv.Sigla, v.cod_origen Codi_Origen, v.CODI_SUBRUTA Codi_Destino,vd.NUME_BOLETO Boleto,v.tipo, v.id_venta From Venta v
